<?php
require_once('../db.php');
$query1 = "SELECT * FROM `cargo` WHERE id = 1";
    ...
    <div class="navbar-white">
      ...
      <div class="profile">
        ...
        <div class="profile-content">
          <div class="info" onclick="window.location.href='../Login.phpb';">
            <span><?php $data= mysqli_fetch_assoc($result2); echo strtoupper($data['usuario']);?></span>
